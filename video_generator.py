...
class VideoGenerator:
    ...
    def generate_thumbnail(self, thumbnail_prompt):
        ...
        Basarisiz olursa None doner (yukleme sirasinda thumbnail atlanir, video yine de yuklenir).
        """
        try:
            ...
            result = fal_client.subscribe(
                "fal-ai/flux-pro",
                arguments={
                    "prompt": thumbnail_prompt + " High detail, striking composition, thumbnail-worthy, 16:9 landscape.",
